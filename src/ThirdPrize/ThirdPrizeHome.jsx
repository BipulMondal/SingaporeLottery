...
const ThirdPrizeHome = ({setLiveDraw, setPrizePosition, singleDrawTime}) => {
  ...
  return status ? (
    ...
    <ThirdPrizeResult setLiveDraw={setLiveDraw} resultData={resultData} setPrizePosition={setPrizePosition} singleDrawTime={singleDrawTime} />
  )
};
