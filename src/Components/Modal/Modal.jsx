  ...
  return (
    ...
    >
      <div class="bg-transparent rounded-lg shadow-lg flex flex-col justify-end w-full space-y-12 lg:space-y-40">
        <div class="flex justify-end md:justify-center lg:justify-center gap-10 items-center p-4 text-gray-800 font-bold mt-4">
          <h3 className="text-[10px] mg:text-[18px] lg:text-[22px]">Draw Date: {data.game_date}</h3>
          <h3 className="text-[10px] mg:text-[18px] lg:text-[22px]">Draw Time: {singleDrawTime}</h3>
        </div>

        <div class="p-4 text-gray-800 font-bold text-center">
